    ...
    const work = [
        {
            ...
            link: 'https://bharatauto.com.au/',
        },
        {
            name: 'Planet Psychology ',
            icon: '/assets/planetps.png',
            description: 'Web Development',
            link: 'https://planet-psychology.com/',
        },
        {
            name: 'water purification solutions',
            icon: '/assets/conver.png',
            description: 'Web Development',
            link: 'https://convergenceassociates.in/',
        },
        {
                    ...
                    <div key={work.name} className="aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group" style={{ backgroundImage: `url(${work.icon})` }}>
                        <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
                            ...
                            <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition">
                                <a href={work.link} target="_blank"><img src="/assets/send-icon.png" alt="" className="w-5" /></a>
                            </div>
                        </div>
                    </div>
                ))}
