    ...
    const data = [
        {
            ...
            description: 'HTML, CSS,WordPress,Shopify,Node Js JavaScript React Js, Next Js',
        },
        {
            name: 'Education',
        ...
        },
        {
            ...
            description: 'Built more than 100 projects',
        },
    ];
    return (
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am a web developer focused on designing clean user interfaces, developing modern web applications, and delivering reliable digital solutions. I combine creativity with technical skills to build fast, responsive, and scalable websites.</p>
